...
is configured to include the [hotspot=192-213]`liberty-maven-plugin`, which allows
...
element in the [hotspot=192-213 file=0]`liberty-maven-plugin` plug-in.
...
package. This property then propagates to the [hotspot=192-213 file=0]`liberty-maven-plugin`
