...
The [hotspot=16-32 file=1]`SystemReadinessCheck` class will verify that the `system` 
...
The [hotspot=15-29 file=2]`SystemLivenessCheck` class will report a status of `DOWN` if  
