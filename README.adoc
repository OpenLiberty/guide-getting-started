...
:page-seo-title: Getting started with Maven and Docker to package and deploy Java microservices on Open Liberty
:page-seo-description: A getting started tutorial and an example on how to build a simple RESTful Java microservice using Maven and containerize the application along with server configuration using Docker.
