...
[role="code_command hotspot=1-21", subs="quotes"]
----
To add the MicroProfile Health feature to the server, replace the `src/main/liberty/config/server.xml` server configuration file
...
[role="code_command hotspot=1-279", subs="quotes"]
----
