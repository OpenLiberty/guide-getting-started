...
whether it's application source code or configuration. Liberty server automatically reloads the configuration without restarting. This allows for quicker turnarounds and an improved developer experience.
