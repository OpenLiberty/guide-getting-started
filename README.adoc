...
is configured to include the [hotspot=183-205]`liberty-maven-plugin` Liberty Maven plug-in, which allows 
...
the features that you defined in the [hotspot=* file=1]`server.xml` file, use 
