...
Update the [hotspot file=0]`mpData.js` file to change the [hotspot=jsUrl file=0]`url` in the [hotspot file=0]`getSystemProperties` method to reflect the new context root.
