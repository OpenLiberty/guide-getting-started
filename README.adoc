...
The Open Liberty Maven plugin includes a `dev` goal, which listens for any changes in the project, 
whether it's application source code or configuration.
...
In addition to starting the Open Liberty server, development mode automatically picks up
changes you make to your application and allows you to run tests by pressing "enter".
