...
the [hotspot=3-8 file=1]`features` that you defined in the [hotspot file=1]`server.xml` file, use 
...
package and generates a runnable JAR file that contains only the [hotspot=3-8 file=1]`features` that you 
