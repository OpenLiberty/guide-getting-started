...
Update the [hotspot file=0]`server.xml` file to use the HTTP port `9090` instead of `9080`.
...
http://localhost:9090/system/properties[http://localhost:9080/system/properties^]
URL. Notice that the port number is now `9090`. 
